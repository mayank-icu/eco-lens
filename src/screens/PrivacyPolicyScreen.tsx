            ...
            >
                <View style={styles.card}>
                    ...
                    <Text style={styles.paragraph}>
                        Eco Lens collects information you provide directly to us when you create an account,
                    ...
                    <Text style={styles.paragraph}>
                        Eco Lens requires camera access to scan plastic items and storage access to save scan
