            ...
            >
                <View style={styles.card}>
                    ...
                    <Text style={styles.paragraph}>
                        By accessing and using PlastiSort, you accept and agree to be bound by the terms and
                    ...
                    <Text style={styles.paragraph}>
                        PlastiSort is a mobile application that helps users identify different types of plastic
                    ...
                    <Text style={styles.paragraph}>
                        To use certain features of PlastiSort, you must create an account. You are responsible for:
                    </Text>
                    ...
                    <Text style={styles.paragraph}>
                        While we strive for accuracy, PlastiSort's AI-powered plastic identification is provided
                    ...
                    <Text style={styles.paragraph}>
                        All content, features, and functionality of PlastiSort, including but not limited to
                        text, graphics, logos, icons, images, and software, are the exclusive property of
                        PlastiSort and are protected by copyright, trademark, and other intellectual property laws.
                    </Text>

                    <Text style={styles.sectionTitle}>7. User-Generated Content</Text>
                    <Text style={styles.paragraph}>
                        By sharing achievements or scan results, you grant PlastiSort a non-exclusive,
                    ...
                    <Text style={styles.paragraph}>
                        PlastiSort shall not be liable for any indirect, incidental, special, consequential,
                    ...
                    <Text style={styles.paragraph}>
                        ...
                        material changes. Your continued use of PlastiSort after such modifications constitutes
